        ...
        //     // Render all products, but control visibility with transform
        ...
        //     // Apply transform to show the desired set of 4
        ...
        //         nextButton.disabled = (startIndex + 1) * 315 >= cardList.scrollWidth - (4 * 315); // Disable when near the end
        //     } else {
        ...
        //                 if (currentIndex * 315 < (products.length - 4) * 315) { // Allow movement if more products exist
        //                     currentIndex += 1;
        //                     renderProducts(products, currentIndex);
        //                 }
        //             });
